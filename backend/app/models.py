...
class Users(db.Model):
    ...
    results = db.relationship('Result', back_populates='user')  # Añadido esta línea
    auth_tokens = db.relationship('AuthToken', back_populates='user')  # Cambiado de backref a back_populates
...
class Diagnostic(db.Model):
    ...
    videos = db.relationship('Video', back_populates='diagnostic', cascade="all, delete-orphan")
    images = db.relationship('Image', back_populates='diagnostic', cascade="all, delete-orphan")
    questionnaires = db.relationship('Questionnaire', back_populates='diagnostic', cascade="all, delete-orphan")
    user = db.relationship('Users', back_populates='diagnostics')
    results = db.relationship('Result', back_populates='diagnostic', cascade="all, delete-orphan")
...
class Video(db.Model):
    ...
    diagnostic = db.relationship('Diagnostic', back_populates='videos')
...
class Questionnaire(db.Model):
    ...
    diagnostic = db.relationship('Diagnostic', back_populates='questionnaires')
...
class Result(db.Model):
    ...
    diagnostic = db.relationship('Diagnostic', back_populates='results')
...
class AuthToken(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=db.func.current_timestamp())
    user = db.relationship('Users', back_populates='auth_tokens')  # Cambiado de backref a back_populates
